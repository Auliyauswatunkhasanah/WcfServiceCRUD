...
namespace WcfServiceapplication
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string msg;
            SqlConnection con = new SqlConnection("Data Source = LAPTOP-FL3VMLAT; Initial Catalog = MyTestDB; Persist Security Info=True; User ID=sa; Password=newWorld; Pooling=False");
            con.Open();
